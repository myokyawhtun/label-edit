<template>
	<div class="vlabeledit">
		...
		<input type="text" v-if="edit" v-model="label" v-on:blur="updateTextBlur" ref="labeledit"
			   :placeholder="vplaceholder" class="vlabeledit-input" @keyup.enter="updateTextEnter"/>
	</div>
</template>
<script>
    export default{
        ...
        props: ['text','placeholder', 'name'], // parent should provide :text or :placeholder and then 'name'
        methods: {
            initText: function(){
            ...
            updateTextBlur: function(){
                ...
                this.$emit('text-updated-blur-with-name',this.label, this.name);
            },
            updateTextEnter: function(){
                this.edit = false;
                this.$emit('text-updated-enter',this.label);
                this.$emit('text-updated-enter-with-name',this.label, this.name);
            }
        },
        computed: {
